...
<html>
    ...
    <head>
        ...
        <link href="<c:url value="/resources/css/morris-0.4.3.min.css" />" rel="stylesheet"  type="text/css" />	      
    ...
    <body>          
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html">
                        <strong>Sispro Network Monitoring</strong>
                    </a>
                </div>
                <!-- /.navbar-header -->
        ...
        <script src="<c:url value="/resources/js/dashboard-demo.js" />"></script>        
